...
export default function AccountModal({ isOpen, onClose, initialTab, asPage = false }: AccountModalProps) {
  ...
  const { user, getIdToken, uploadProfilePhoto, updateUserPhotoURL, getPhotoHistory, savePhotoHistory, deleteAccount, reauthenticateUser, isTranslator, userRole } = useAuth();
