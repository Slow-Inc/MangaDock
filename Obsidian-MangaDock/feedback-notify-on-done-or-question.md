---
name: feedback-notify-on-done-or-question
tags: ["feedback"]
...
ยิงเมื่อ: (1) จบ task/รอบ /tdd, (2) ต้องถาม/รอ user confirm (เช่น ก่อนปิด issue ตาม [[feedback-self-review]], ก่อน merge), (3) AFK แล้วงานชุดเสร็จ ตาม [[feedback-test-every-round]]. อย่ายิงถี่ระหว่าง progress ย่อยๆ ที่ user เห็นอยู่แล้ว — เด้งเฉพาะจุดที่ต้องดึงความสนใจกลับจริงๆ
