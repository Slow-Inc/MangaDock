...
เอกสารฉบับนี้สรุปบทบาทของ Manga Image Translator (MIT) ภายในระบบ MetaBooks และใช้อ้างอิงร่วมกับ [MIT README](../../MIT/README.md) ซึ่งเป็นเอกสารหลักของ service
...
## 2. Role of MIT in MetaBooks

ภายในระบบ MetaBooks บริการ MIT ไม่ได้เป็นส่วนหนึ่งของ NestJS backend โดยตรง แต่ทำงานในลักษณะ service แยกที่ backend เรียกใช้งานผ่าน HTTP ทำให้สามารถ deploy แยกเครื่อง แยก environment หรือแยกภาระงานประมวลผลออกจากระบบหลักได้
...
3. ทำให้ระบบ MetaBooks เปลี่ยนปลายทางของ translation service ได้ผ่าน config
...
ในบริบทของ MetaBooks แนวทางใช้งานที่แนะนำคือ
...
- [../Software Engineer/SE_PHASE2_SRS_AND_SYSTEM_ANALYSIS.md](../Software%20Engineer/SE_PHASE2_SRS_AND_SYSTEM_ANALYSIS.md): เอกสารวิเคราะห์ระบบที่กล่าวถึง integration ของ MIT กับ MetaBooks
...
MIT เป็นบริการเฉพาะทางที่ทำหน้าที่สำคัญในระบบ MetaBooks โดยเฉพาะในส่วนการแปลภาพมังงะ เอกสารฉบับนี้จึงทำหน้าที่เป็นสะพานเชื่อมระหว่าง README หลักของ service กับเอกสารเชิงโครงการ เพื่อให้ผู้อ่านเข้าใจทั้งมุมมองเชิงเทคนิคและมุมมองเชิงสถาปัตยกรรมของระบบร่วมกัน