...
เอกสารฉบับนี้รวบรวมการเตรียมความพร้อมก่อนนำระบบ MangaDock ไปใช้งานจริงหรือสาธิตในสภาพแวดล้อมที่ใกล้เคียงการใช้งานจริง โดยครอบคลุมแผนการติดตั้ง การเตรียม hardware และ software คู่มือ installation คู่มือใช้งาน และคู่มือประจำระบบ
