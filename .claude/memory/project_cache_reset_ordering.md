...
See [[project_benchmark_e2e_flow]] for the rest of the Reader E2E flow. Direct `/translate/with-form/image` (the [[project_mit_launch_env]] direct path) bypasses the backend cache entirely and is the fastest way to verify a render code change.
