---
name: feedback_update_readme_on_command_change
...
**How to apply:** เอกสารคำสั่งใหม่ให้ครบชุดที่เกี่ยวข้อง — `README.md` (root, bilingual EN+TH ตาม [[feedback_bilingual_issues]]), README ของ service ที่เป็นเจ้าของคำสั่ง (เช่น `Backend/README.md`), `CLAUDE.md` (commands ทั้งบล็อก EN+TH), และ log ลง `DONE.md` ตาม [[feedback_md_history_log]] เคสตัวอย่าง: `npm run cache:reset` → เขียนครบทั้ง 4 ที่ + memory [[feedback_clear_cache_before_test]]
