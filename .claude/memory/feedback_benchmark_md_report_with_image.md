...
**งาน MIT ทุกชิ้น (เมื่อเสร็จ) ต้อง benchmark เพื่อยืนยัน result เสมอ — เป็นส่วนหนึ่งของ "done" ไม่ใช่ทางเลือก.** code+test ผ่านอย่างเดียวยังไม่นับว่าเสร็จ; ต้องมี benchmark (deterministic ถ้าทำได้ ไม่งั้น E2E) + MD report + ภาพ ยืนยันว่าผลลัพธ์จริงดีขึ้น/ไม่ regress ก่อน (ต่อยอดจาก [[feedback_definition_of_done]]).
