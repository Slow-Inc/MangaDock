...
- [Feedback: Definition of Done (gate ทุก task)](feedback_definition_of_done.md) — code+test+E2E+scrutinize+DONE.md+impact-report+ADR+notify ครบทุกครั้ง ไม่งั้นยังไม่ done
