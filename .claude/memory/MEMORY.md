...
- [Feedback: impact report](feedback_impact_report.md) — งานสำคัญที่กระทบระบบ + tech debt ให้บันทึกลง docs/reports/system-impact-report.md (report-level) เพิ่มจาก DONE.md
