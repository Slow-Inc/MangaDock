...
OPENAI_API_BASE = os.getenv('OPENAI_API_BASE', 'https://api.openai.com/v1') # 兼容 OpenAI 的本地服务示例: http://localhost:11434/v1

# sakura
SAKURA_API_BASE = os.getenv('SAKURA_API_BASE', 'http://localhost:8080/v1') # SAKURA API地址
