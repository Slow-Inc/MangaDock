...
>
> **Remaining = the high-risk async-orchestration core (tail):** S22 DispatchRegistry (deps S4 ✅), **S23 StageRunner (▶️ next — deps S15/S11/S14 all ✅)**, S24 PatchRenderer (deps S23), S25 PipelineOrchestrator (deps S23), S26 BatchModeOrchestrator (last). Plus S12 value-object (🔒 #192). S14 + S15 landed 2026-06-10 (debug_sink + stages, E2E'd; god object down to 1 cv2.imwrite, leaf dispatches now testable adapters). Each needs E2E-per-step, not AFK.
