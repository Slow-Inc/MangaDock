...
>
> **Remaining = the high-risk async-orchestration core (tail):** S22 DispatchRegistry (deps S4 ✅), **S23 StageRunner (◐ code landed `f1ce7a3`, E2E pending)**, **S24 PatchRenderer (◐ code landed `2eac7dd`+`8fa69d3`, E2E pending)**, **S25 PipelineOrchestrator (▶️ next — deps S23 ✅)**, S26 BatchModeOrchestrator (last). Plus S12 value-object (🔒 #192). S23+S24 landed 2026-06-10 (stage_runner + patch_geometry/patch_renderer; driver 2235→**1999** lines, broke below 2000). Each needs E2E-per-step, not AFK — S23+S24 E2E batched (one MIT restart).
