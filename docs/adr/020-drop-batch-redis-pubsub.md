# ADR 020 — Drop the batch-translate Redis pub/sub (single-node)

> Renumbered from 002 → 020 on 2026-07-08 to resolve a filename-number collision with `002-mit-inpaint-luminance-reground.md` (020 is free on both this branch and `main`).
