# PRD / Epic — Dashboard redesign: live-native (real MIT data or "No Data") + Finesse UI design system

> Status: Ready-for-agent (2026-06-17). Parent: #279 (Staff Console). Relates to #282 / #283 (Frontend/Backend
> live feeds — the "No Data" dependency). Design direction: **Finesse UI** (https://finesseui.com/ — professional/SaaS
> aesthetic, atomic spacing, light/dark, configurable corner radius). Design + scope locked via a `/grill-me` session.
...
- **Design direction = Finesse UI** (professional/SaaS, atomic spacing, light/dark, configurable corner radius).
...
- **Design direction = Finesse UI** (professional/SaaS, atomic spacing, light/dark, corner radius เลือกได้)
